...
<head>
    ...
    <link rel="stylesheet" href="{{URL::asset('gii-assets/styles/iview.css')}}">
</head>
<body>
<style scoped>
    .layout {
...
<script src="{{URL::asset('gii-assets/vue.js')}}"></script>
<script src="{{URL::asset('gii-assets/iview.js')}}"></script>
@yield('assets')
@section('new_vue')
<script>
    var vm = new Vue({
